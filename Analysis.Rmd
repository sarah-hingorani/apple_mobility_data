...
# make a histogram of relative transit mobility data within the state. put the
# date on the x axis and the relative mobility on the y axis.
histogram_plot <- long_subset %>%
  ...
  geom_histogram(col = "black", 
                 ...
                 binwidth = 15,
                 alpha = 0.9) +
  labs(title = paste("Realtive mobility by transit in", state_to_analyze,
                     "during COVID"),
                      xlab = "Date",
